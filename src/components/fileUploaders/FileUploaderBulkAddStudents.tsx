...
const FileUploader: React.FC<FileUploaderProps> = ({
    ...
    const handleDownloadTemplate = () => {
        const templateData = [
            ["ID", "FIRSTNAME", "MIDDLE INITIAL", "LASTNAME", "SEX"],
            ["C-2022-0001", "Juan", "A.", "Dela Cruz", "MALE"],
            ["C-2022-0002", "Maria", "Q.", "Santos", "FEMALE"],
        ];
        ...
        <div className="w-full">
            <div className="flex gap-3 items-center justify-between w-full">
                ...
                <div className="flex flex-col space-y-3 basis-1/2 min-w-0">
                    <h1 className="text-black text-lg font-semibold">Bulk Add Students</h1>
                    ...
                    <button
                        ...
                        className="bg-blue-600 text-white px-3 py-1 rounded-md w-[150px] cursor-pointer hover:bg-blue-700 transition disabled:opacity-50 text-sm"
                    >
                        {isUploading ? "Extracting..." : "Extract"}
                    </button>
                </div>

                {/* Right side - Template section */}
                <div className="flex flex-col items-center justify-center space-y-2 basis-1/2 min-w-0">
                    <div className="text-sm text-blue-900 px-2 py-1 rounded-md text-center">
                        ...
                        Please view EXCEL file template to avoid mistakes on
                        uploading student information through excel file import.
                    </div>
